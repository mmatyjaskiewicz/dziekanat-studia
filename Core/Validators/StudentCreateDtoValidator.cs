...
public class StudentCreateDtoValidator : AbstractValidator<StudentCreateDto>
{
    public StudentCreateDtoValidator()
    {
        ...
        RuleFor(x => x.StudentId)
            ...
            .MaximumLength(20).WithMessage("Numer albumu nie moĂ…ÂĽe przekraczaĂ„â€ˇ 20 znakĂÂłw.");
        RuleFor(x => x.ProgramCode)
            .NotEmpty().WithMessage("Kod kierunku jest wymagany.");
        RuleFor(x => x.EnrollmentYearFrom)
            .GreaterThan(2000).WithMessage("Rok rozpoczĂ„â„˘cia musi byĂ„â€ˇ wiĂ„â„˘kszy od 2000.");
    }
}
